...
import com.water.ui.util.WaterUIResHelper;

import java.lang.ref.WeakReference;

public class WaterUIAlphaViewHelper {
    ...
    public WaterUIAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
        mPressedAlpha = WaterUIResHelper.getAttrFloatValue(target.getContext(), R.attr.waterui_alpha_pressed);
        mDisabledAlpha = WaterUIResHelper.getAttrFloatValue(target.getContext(), R.attr.waterui_alpha_disabled);
    }

    public WaterUIAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
