...
public class WaterUIDeviceHelper {
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                WaterUILog.printErrStackTrace(TAG, e, "read file error");
            } finally {
                WaterUILangHelper.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            WaterUILog.printErrStackTrace(TAG, e, "read SystemProperties error");
        }
    }
