 ...
 * @date 2016-03-27
 */
public class WaterUIStatusBarHelper {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(WaterUIDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (WaterUINotchHelper.isNotchOfficialSupport()) {
            handleDisplayCutoutMode(window);
        }

        // 小米和魅族4.4 以上版本支持沉浸式
        // 小米 Android 6.0 ，开发版 7.7.13 及以后版本设置黑色字体又需要 clear FLAG_TRANSLUCENT_STATUS, 因此还原为官方模式
        if (WaterUIDeviceHelper.isMeizu() || (WaterUIDeviceHelper.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (WaterUIDeviceHelper.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean Android6SetStatusBarLightMode(Window window, boolean light) {
        ...
        if (WaterUIDeviceHelper.isMIUIV9()) {
            // MIUI 9 低于 6.0 版本依旧只能回退到以前的方案
            // https://github.com/Tencent/WaterUI_Android/issues/160
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (WaterUIDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return WaterUIDeviceHelper.isMIUIV5() || WaterUIDeviceHelper.isMIUIV6() ||
                WaterUIDeviceHelper.isMIUIV7() || WaterUIDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(WaterUIDeviceHelper.isZUKZ1() || WaterUIDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        try {
            ...
            if (WaterUIDeviceHelper.isMeizu()) {
                try {
        ...
        if (WaterUIDeviceHelper.isTablet(context)
                && sStatusbarHeight > WaterUIDisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
