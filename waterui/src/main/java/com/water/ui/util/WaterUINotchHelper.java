...
public class WaterUINotchHelper {

    private static final String TAG = "WaterUINotchHelper";
    ...
    public static boolean has3rdNotch(Context context){
        if (WaterUIDeviceHelper.isHuawei()) {
            return hasNotchInHuawei(context);
        } else if (WaterUIDeviceHelper.isVivo()) {
            return hasNotchInVivo(context);
        } else if (WaterUIDeviceHelper.isOppo()) {
            return hasNotchInOppo(context);
        } else if (WaterUIDeviceHelper.isXiaomi()) {
    ...
    private static Rect get3rdSafeInsetRect(Context context){
        // 全面屏设置项更改
        if (WaterUIDeviceHelper.isHuawei()) {
            boolean isHuaweiNotchSetToShow = WaterUIDisplayHelper.huaweiIsNotchSetToShowInSetting(context);
    ...
    private static Rect getRectInfoRotation0(Context context) {
        ...
        if (WaterUIDeviceHelper.isVivo()) {
            ...
            rect.top = WaterUIStatusBarHelper.getStatusbarHeight(context);
            rect.bottom = 0;
        } else if (WaterUIDeviceHelper.isHuawei()) {
    ...
    private static Rect getRectInfoRotation90(Context context) {
        ...
        if (WaterUIDeviceHelper.isVivo()) {
            ...
            rect.left = WaterUIStatusBarHelper.getStatusbarHeight(context);
            rect.right = 0;
        } else if (WaterUIDeviceHelper.isHuawei()) {
    ...
    private static Rect getRectInfoRotation180(Context context) {
        ...
        if (WaterUIDeviceHelper.isVivo()) {
            ...
            rect.top = 0;
            rect.bottom = WaterUIStatusBarHelper.getStatusbarHeight(context);
        } else if (WaterUIDeviceHelper.isHuawei()) {
            int[] notchSize = getNotchSizeInHuawei(context);
            rect.top = 0;
    ...
    private static Rect getRectInfoRotation270(Context context) {
        ...
        if (WaterUIDeviceHelper.isVivo()) {
            ...
            rect.right = WaterUIStatusBarHelper.getStatusbarHeight(context);
            rect.left = 0;
        } else if (WaterUIDeviceHelper.isHuawei()) {
            if (sHuaweiIsNotchSetToShow) {
    ...
    public static int getNotchHeightInXiaomi(Context context) {
        ...
        return WaterUIDisplayHelper.getStatusBarHeight(context);
    }

    public static int getNotchWidthInVivo(Context context){
        return WaterUIDisplayHelper.dp2px(context, 100);
    }

    public static int getNotchHeightInVivo(Context context){
        return WaterUIDisplayHelper.dp2px(context, 27);
    }
    ...
    public static boolean needFixLandscapeNotchAreaFitSystemWindow(View view){
       return WaterUIDeviceHelper.isXiaomi() && WaterUINotchHelper.hasNotch(view);
    }
